...
local Window = OrionLib:MakeWindow({Name = "HATOR HUB", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
Tab:AddParagraph("Freeze","Freezing Player")
Tab:AddToggle({
	Name = "Freeze",
	Default = false,
...
Tab:AddParagraph("Skeleton/Tracer","")
Tab:AddButton({
	Name = "Tracer",
	Callback = function()  
